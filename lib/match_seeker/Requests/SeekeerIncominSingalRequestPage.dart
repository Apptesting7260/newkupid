...
class _SeekerIncomingRequestSinglePageState
    extends State<SeekerIncomingRequestSinglePage> {
                            ...
                            Row(
                              children: [
                                ...
                                Container(
                                  ...
                                  width: Get.width * 0.4,
                                  child: CachedNetworkImage(
                                    imageUrl: myUserUrl.imgPath.toString(),
                                    imageBuilder: (context, imageProvider) =>
                                        Container(
                                      height: Get.height * 0.25,
                                      width: Get.width * 0.4,
                              ...
                              children: [
                                ...
                                (myUserUrl.details!.interestName != null ||
                                    ...
                                    ? Row(
                                        children: [
                                          for (var i = 0;
                                              myUserUrl.details!.interestName!
                                                      .length >
                                                  i;
                                              i++)
                                            Container(
...
// }
                    ...
                    : myId ==
                            ...
                            myId ==
                                    seekerOutgoingRequestSinglePageController
                                        .ViewProfileDetail.value.data!.matchFrom
                                        .toString() &&
                                seekerOutgoingRequestSinglePageController
                                        .ViewProfileDetail
                                        .value
                            ...
                            children: [
                              GestureDetector(
                                onTap: () {
                                  ...
                                  RequestAcceptControllerinstance
                                      .RequestAcceptApiHit();
