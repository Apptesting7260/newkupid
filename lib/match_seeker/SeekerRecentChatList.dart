...
class SeekerRecentConversations extends StatefulWidget {
  const SeekerRecentConversations({Key? key}) : super(key: key);

  @override
  State<SeekerRecentConversations> createState() =>
      _SeekerRecentConversationsState();
}

class _SeekerRecentConversationsState extends State<SeekerRecentConversations> {
                                  ...
                                  child: ListTile(
                                    ...
                                    trailing: InkWell(
                                        onTap: () {
                                          ...
                                          print(
                                              "======================================anotherseeker=================$anotherCollecatinName================================");
                                          print(
                                              "=======================================================$collecatinName================================");
                                          print(
                                              "=======================================================$roomid==========================");
                                          ...
                                          if (makeride == true) {
                                            ...
                                            print(
                                                "makwr id ${data['maker_id']}==================================================================================1222522");
                                          }
                                          anotherchatuser = "s" +
                                                      seekerMyProfileController
                                                          .SeekerMyProfileDetail
