...
class ViewRequestDetailsController extends GetxController {
  ...
  void ViewProfileDetails(RequestDetailsModel _value) =>
      ViewProfileDetail.value = _value;
  ...
  Future<dynamic> ViewRequestDetailsApiHit() async {
    ...
    Map data = {"request_id": requestid.toString()};
    ...
    _api.RequestDetailsApi(data).then((value) async {
      ...
      print(_firestore
          .collection(value.data!.getseeker!.id.toString())
      ...
      Future<bool> doesDocumentExist(
        ...
        final documentReference = FirebaseFirestore.instance
            .collection("s" + value.data!.getseeker!.id.toString())
            .doc(value.data!.roomid.toString());
...
// Example usage:
      ...
      var image = seekerMyProfileController
      ...
      var image2 = seekerMyProfileController
                  .SeekerMyProfileDetail.value.ProfileDetail!.id
                  .toString() !=
              value.data!.getseeker!.id.toString()
          ? value.data!.getanotherseeker!.imgPath.toString()
          : value.data!.getseeker!.imgPath.toString();
      var seekerId = seekerMyProfileController
                  .SeekerMyProfileDetail.value.ProfileDetail!.id
                  .toString() ==
              value.data!.getseeker!.id.toString()
          ? value.data!.getanotherseeker!.id.toString()
          : value.data!.getseeker!.id.toString();
      var seekerId2 = seekerMyProfileController
                  .SeekerMyProfileDetail.value.ProfileDetail!.id
                  .toString() !=
              value.data!.getseeker!.id.toString()
          ? value.data!.getanotherseeker!.id.toString()
      ...
      if (exists) {
        ...
        if (value.data!.matchWith.toString() != "null" &&
            value.data!.roomid.toString() != "null") {
          roomdetails = {
            ...
            if (value.data!.matchType.toString() == "0" ||
                value.data!.matchType.toString() == "2" ||
                value.data!.matchType.toString() == "3")
              "roomname": value.data!.getseeker!.id.toString() ==
                  ...
                  : value.data!.getseeker!.name.toString() +
                      " & " +
                      value.data!.getmaker!.name.toString(),
            if (value.data!.makerId.toString() == "null")
              "roomname": value.data!.getseeker!.id.toString() ==
                      seekerMyProfileController
                          .SeekerMyProfileDetail.value.ProfileDetail!.id
                          .toString()
            ...
            if (value.data!.matchType.toString() == "0" ||
              ...
              "roomname": value.data!.getseeker!.id.toString() !=
                  ...
                  : value.data!.getseeker!.name.toString() +
                      " & " +
                      value.data!.getmaker!.name.toString(),
            if (value.data!.getmaker.toString() == "null")
              "roomname": value.data!.getseeker!.id.toString() !=
                      seekerMyProfileController
                          .SeekerMyProfileDetail.value.ProfileDetail!.id
                          .toString()
          ...
          if (value.data!.matchType.toString() == "0" ||
            ...
            if (value.data!.matchType.toString() == "0" ||
              ...
              await _firestore
                  .collection(
                    "m" + value.data!.makerId.toString(),
                  )
                  .doc(value.data!.roomid.toString())
                  .set(roomdetailsmaker);
            if (value.data!.matchType.toString() == "0" ||
                value.data!.matchType.toString() == "2" ||
                value.data!.matchType.toString() == "3")
              makerchatuser = value.data!.makerId.toString();
          }
