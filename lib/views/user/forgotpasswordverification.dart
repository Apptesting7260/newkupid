...
class ForgotVerification extends StatefulWidget {
 ...
 String ?otp;
  ...
  ForgotVerification({@required this.otp});
  @override
...
print(widget.otp.runtimeType);
String toverifyotp=OtpVerificationInstanse.OtpController.value.text;
print(toverifyotp.runtimeType);
setState(() {
  Verificationotp=toverifyotp;
});
                    if(widget.otp==toverifyotp){
                   Get.to(   ResetPassword());
                   OtpVerificationInstanse.OtpController.value.clear();
                    }else{
