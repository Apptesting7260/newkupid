...
import '../controllers/controller/MakerProfileController/MakerUpdateContoller.dart';
...
class MakerUpdateProfileDetails extends StatefulWidget {
  const MakerUpdateProfileDetails({Key? key}) : super(key: key);

  @override
  State<MakerUpdateProfileDetails> createState() =>
      _MakerUpdateProfileDetailsState();
}

class _MakerUpdateProfileDetailsState extends State<MakerUpdateProfileDetails> {
  ...
  MakerUpdateProfileController MakerProfileControllerInstanse =
      Get.put(MakerUpdateProfileController());
  ...
  void initState() {
    ...
    super.initState();
    MakerProfileControllerInstanse.setData();
                  ...
                  children: <Widget>[
                          ...
                          children: [
                              ...
                              child: ClipOval(
                                  child: imgFile == null
                                      ...
                                      child:    imageUrl == null || imageUrl == ""
                                          ? CachedNetworkImage(
                                        imageUrl:  'https://cdn-icons-png.flaticon.com/512/847/847969.png?w=740&t=st=1691391117~exp=1691391717~hmac=c402e52cf04c8941cd7bc1fae55a6ed27830a0e3f82a34da252300f7b68ce614',
                                        height: height,
                                        width: width,
                                        fit: BoxFit.cover, )
                                          : CachedNetworkImage(
                            ...
                            Positioned(
                                ...
                                child: GestureDetector(
                                    ...
                                    child: imgFile == null&& imageUrl == null || imageUrl == ""
                                        ? Image.asset(
                    ...
                    TextFormField(
                      ...
                      onChanged: (value) {
                        print(value);
                        setState(() {
                          if (MakerProfileControllerInstanse
                    ...
                    Visibility(
                      visible: MakerProfileControllerInstanse
                      ...
                      child: Container(
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) => ListTile(
                                  onTap: () {
                                    setState(() {
                                      MakerProfileControllerInstanse
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        contentPadding: EdgeInsets.all(20),
                        hintText:
                            "Type Something about the Match Maker Heading",
                        hintStyle: Theme.of(context)
                            .textTheme
                            .bodyLarge
                            ?.copyWith(color: AppColors.subtitletextcolor),
