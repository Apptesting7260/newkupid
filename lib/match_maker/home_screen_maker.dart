...
import '../match_seeker/Requests/SeekerRequestPage.dart';
      ...
      child: Scaffold(
          ...
          body: SingleChildScrollView(child: Obx(() {
            final myProfileStatus =
                recentMakerMatchesController.rxRequestStatus.value;
            ...
            if (myProfileStatus == Status.ERROR ||
              ...
              if (recentMakerMatchesController.rxRequestStatus.value ==
                      'No internet' ||
                  makerRequestController.rxRequestStatus.value ==
                      'No internet') {
                                                            ...
                                                            child: Container(
                                                              ...
                                                              decoration:
                                                                ...
                                                                image: DecorationImage(
                                                                    image: CachedNetworkImageProvider(recentMakerMatchesController
                                                                        .RecentMakerMatchesValue
                                                                        .value
                                                                        .requests![
                                                                            index]
                                                              ...
                                                              child:
                                                                ...
                                                                backgroundColor:
                                                                    AppColors
                                                                        .white,
                                                                child: Icon(Icons
                                                                    .heart_broken , color: Colors.pinkAccent,),
                                                              ),
                                                            ),
                                                          ),
                                                          Positioned(
                                            ...
                                            ? Container(
                                                ...
                                                child: ListView.builder(
                                                    ...
                                                    itemBuilder:
                                                      ...
                                                      var data = snapshot
                                                          .data?.docs[index];
                                                      var timestamp = data!['timestamp']; // Assuming 'timestamp' is of type Timestamp
...
// Extract only the date part
                                                          ...
                                                          String formattedDate = DateFormat('dd/MM/yyyy').format(dateOnly);
                                                      return Padding(
                                                        padding: const EdgeInsets.all(8.0),
                                                        child: InkWell(
                                                          child: Container(
                              ...
                              makerRequestController.makerHomePageValue.value
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            Stack(
                                                                          children: [
                                                                            makerRequestController.makerHomePageValue.value.requests!.incoming![index].getanotherseeker!.imgPath != null || makerRequestController.makerHomePageValue.value.requests!.incoming![index].getanotherseeker!.imgPath != []
                                                                                ? CircleAvatar(
                                                                                    backgroundImage: CachedNetworkImageProvider(makerRequestController.makerHomePageValue.value.requests!.incoming![index].getanotherseeker!.imgPath.toString()),
                                                                                    radius: 30,
                                                                                ...
                                                                                : CircleAvatar(
                                                                                    ...
                                                                                    backgroundImage: NetworkImage('https://images.pexels.com/photos/33109/fall-autumn-red-season.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'),
                                                                                  ),
                                                                            Positioned(
                                                                              left: 25,
                                                                              child: makerRequestController.makerHomePageValue.value.requests!.incoming![index].getseeker!.imgPath != null
                                                                                  ? CircleAvatar(
                                                                                      backgroundImage: CachedNetworkImageProvider(makerRequestController.makerHomePageValue.value.requests!.incoming![index].getseeker!.imgPath.toString()),
                                                                                      radius: 30,
                                                                                      backgroundColor: AppColors.white,
                                                                                    )
                                                                                  : CircleAvatar(
                                                                        ...
                                                                        Column(
                                                                          ...
                                                                          children: [
                                                                            Container(
                                                                              width: Get.width * 0.3,
                                                                              child: Text(
                                                                                makerRequestController.makerHomePageValue.value.requests!.incoming![index].getanotherseeker!.name.toString(),
                                                                            ...
                                                                            Container(
                                                                              width: Get.width * 0.3,
                                                                              child: Text(
                                                                                makerRequestController.makerHomePageValue.value.requests!.incoming![index].getseeker!.name.toString(),
                                                                                style: TextStyle(color: Colors.pink, fontSize: 15, fontWeight: FontWeight.bold),
                                                                                overflow: TextOverflow.ellipsis,
                                                                              ),
                                                                            ),
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            Stack(
                                                                          children: [
                                                                            makerRequestController.makerHomePageValue.value.requests!.incoming![index].getseeker!.imgPath != null
                                                                                ? CircleAvatar(
                                                                                    backgroundImage: CachedNetworkImageProvider(makerRequestController.makerHomePageValue.value.requests!.incoming![index].getseeker!.imgPath.toString()),
                                                                                    radius: 30,
                                                                                    backgroundColor: AppColors.white,
                              ...
                              makerRequestController.makerHomePageValue.value
                                      ...
                                      makerRequestController.makerHomePageValue
                                              .value.requests!.outgoing ==
                                          [] ||
                                      makerRequestController
                                              .makerHomePageValue
                                              .value
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Stack(
                                                                              children: [
                                                                                makerRequestController.makerHomePageValue.value.requests!.outgoing![index].getanotherseeker!.imgPath != null
                                                                                    ? CircleAvatar(
                                                                                        backgroundImage: CachedNetworkImageProvider(makerRequestController.makerHomePageValue.value.requests!.outgoing![index].getanotherseeker!.imgPath.toString()),
                                                                                        radius: 30,
                                                                                        backgroundColor: AppColors.white,
                                                                                      )
                                                                                    : CircleAvatar(
                                                                                ...
                                                                                Positioned(
                                                                                  left: 25,
                                                                                  child: makerRequestController.makerHomePageValue.value.requests!.outgoing![index].getseeker!.imgPath != null
                                                                                      ? CircleAvatar(
                                                                                          backgroundImage: CachedNetworkImageProvider(makerRequestController.makerHomePageValue.value.requests!.outgoing![index].getseeker!.imgPath.toString()),
                                                                                          radius: 30,
                                                                                          backgroundColor: AppColors.white,
                                                                                        )
                                                                                      : CircleAvatar(
                                                                          ...
                                                                          Column(
                                                                            children: [
                                                                              Container(
                                                                                width: Get.width * 0.3,
                                                                                child: Text(
                                                                                  makerRequestController.makerHomePageValue.value.requests!.outgoing![index].getanotherseeker!.name.toString(),
                                                                                  style: TextStyle(color: Colors.pink, fontSize: 15, fontWeight: FontWeight.bold),
                                                                                  overflow: TextOverflow.ellipsis,
                                                                                ),
                                                                              ),
                                                                              Container(
                                                                                width: Get.width * 0.3,
                                                                                child: Text(
                                                                                  makerRequestController.makerHomePageValue.value.requests!.outgoing![index].getseeker!.name.toString(),
                                                                                  style: TextStyle(color: Colors.pink, fontSize: 15, fontWeight: FontWeight.bold),
                                                                                  overflow: TextOverflow.ellipsis,
                                                                                ),
                                                                              ),
